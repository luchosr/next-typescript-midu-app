...
export function Row({ tollgate }: any) {
  ...
  return (
    ...
    //   </TableRow>
    // {/* <Modal
    //   open={handleSubmissionModalOpen}
    ...
    // <Modal
    //   open={handleConditionalModalOpen}
      ...
      <TableRow className={classes.mainTableRow}>
        ...
        <TableCell align='right'>
          ...
          !isSubmitted.includes(tollgate?.pre_requisites.name) ? (
            <Button
              variant='contained'
              disabled={!isCompleted.includes(tollgate?.pre_requisites.name)}
              component={'button'}
              onClick={() => handleSubmission(tollgate?.pre_requisites.name)}
              className={classes.submitButton}
            >
              Submit
            </Button>
