...
exports.columnGroupingModel = exports.preReqRows = exports.preReqColumns = void 0;
var Link_1 = require("@material-ui/core/Link");
exports.preReqColumns = [
    {
    ...
    },
    {
        ...
        headerClassName: "readyToBuild-header",
        // @ts-ignore
        renderCell: function (params) { return <Link_1.default href="#">{params.value}</Link_1.default>; },
    },
    {
